...
const Navbar = () => {
  ...
  return (
    <div className="overflow-hidden">
      <nav className="flex justify-evenly items-center bg-orange-50 drop-shadow-sm p-1">
        <div className="flex items-center">
          ...
          <div className="uppercase text-[16px] space-x-5">
            <Link
              href="/"
            ...
            >
              <div className="flex items-center justify-start space-x-3">
                ...
                <div>
                  ...
                  <h1 className="font-light text-xs">{cartItem.price}$/each</h1>
